...
**Implementation**: I2S DMA writes samples directly to a ring buffer in SRAM. The CPU is not involved in the copy — this is the "zero-cost" capture stage. The ring buffer holds 500 ms of audio (8,000 samples × 2 bytes = 16 KB).
